...
const StateProvinceSelectChallenge = ({ formik, country }: Props) => {
  const currentCountry = countryRegions[country];

  return (
    <>
      <label className="text-[15px] pb-2 ">
        {currentCountry.name}
      </label>
      <div className="relative w-full">
        <select
          ...
          className="w-full border-[1px] border-[#a7abad] px-4 py-2 text-[16px] sm:text-[14px] rounded-md bg-white h-12 focus:border-[#00C8FF] focus:outline-none focus:ring-2 focus:ring-[#00C8FF] focus:ring-opacity-50+"
        >
...
export default StateProvinceSelectChallenge;
