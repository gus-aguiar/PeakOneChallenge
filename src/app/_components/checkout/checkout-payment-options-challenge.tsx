...
import StateProvinceSelectChallenge from "./checkout-state-selector-challenge";
import { PriceDisplaySimple } from "./checkout-price-display";
import { CVVHelper } from "./cvv-modal-challenge";
import SubmitButtonChallenge from "./submit-button-challenge";
    ...
    if (addressInputRef.current) {
      ...
      autocomplete.addListener("place_changed", () => {
        ...
        if (place.address_components) {
          ...
          const mainAddress = `${address.street_number || ""} ${address.route || ""
            }`.trim();
    ...
    <>
      {loading && (
        <div className="fixed h-screen w-screen top-0 left-0 z-40 flex justify-center items-center bg-black/20">
          <div className="flex bg-blue-500 text-white p-4 rounded-md h-12 flex-col items-center justify-center w-[280px] h-[140px] text-[18px] font-[500]">
      ...
      <div className="flex w-full justify-start items-center gap-3">
        <Image src="/images/icons/frm-hdr-icn3.png" alt="Timer icon" width={40} height={32} className="object-contain" />
      ...
      <form onSubmit={formik.handleSubmit}>
        <div className="flex w-full space-x-4 mt-4">
          <div className="flex w-full flex-col items-start justify-start relative">
            <label className="text-[15px] mb-2 ">Country</label>
            <div className="relative w-full">
              <select
                onChange={handleCountryChange}
                className="w-full border-[1px] border-[#a7abad]  px-4 py-2 text-[16px] sm:text-[14px] rounded-md h-12 bg-white focus:border-[#00C8FF] focus:outline-none focus:ring-2 focus:ring-[#00C8FF] focus:ring-opacity-50"
        ...
        <div className="flex w-full space-x-4 mt-6">
          <div className="flex w-full flex-col items-start justify-start">
            ...
            <input
              ...
              className="w-full border-[1px] border-[#a7abad] px-4 py-2 text-[16px] sm:text-[14px] mb-2 rounded-md h-12 focus:border-[#00C8FF] focus:outline-none focus:ring-2 focus:ring-[#00C8FF] focus:ring-opacity-50 transition-all duration-800 ease-in-out"
              placeholder="Address"
            />
            ...
            <input
              ...
              className="w-full border-[1px] border-[#a7abad] px-4 py-2 text-[16px] sm:text-[14px]  rounded-md h-12 focus:border-[#00C8FF] focus:outline-none focus:ring-2 focus:ring-[#00C8FF] focus:ring-opacity-50 transition-all duration-800 ease-in-out"
        ...
        <div className="flex w-full space-x-4 mt-6 ">
          <div className="flex w-full flex-col items-start justify-start">
            <label className="text-[15px] mb-2 ">City</label>
            <input
              type="text"
              name="city"
              onChange={formik.handleChange}
        ...
        <div className="flex w-full space-x-4 mt-4">
          <div className="flex w-1/2 flex-col items-start justify-start relative">
            <StateProvinceSelectChallenge formik={formik} country={country} />
        ...
        <div className="flex w-full items-center pb-6 gap-3 float-left pt-6 mt-4">
          <Image src="/images/icons/frm-hdr-icn4.png" alt="Timer icon" width={40} height={32} className="object-contain mx-0 my-auto lg:w-8 lg:h-10 " />
        ...
        <div className="flex w-full space-x-4 mt-6">
          <div className="flex w-full flex-col items-start justify-start">
            <div className="flex items-center justify-between w-full">
              <label className="text-[15px] mb-2 ">Card Number</label>
              <Image
        ...
        <div className="flex w-full space-x-4 mt-4">
          <div className="flex w-1/2 flex-col items-start justify-start relative">
            <label className="text-[15px] mb-2 ">Expiry Month</label>
            <div className="relative w-full">
              <select
                name="month"
                onChange={formik.handleChange}
                ...
                className="w-full border-[1px] border-[#a7abad]  px-4 py-2 text-[16px] sm:text-[14px] rounded-md h-12 bg-white  focus:border-[#00C8FF] focus:outline-none focus:ring-2 focus:ring-[#00C8FF] focus:ring-opacity-50 transition-all duration-800 ease-in-out"
              >
          ...
          <div className="flex w-1/2 flex-col items-start justify-start">
            <label className="text-[15px] mb-2 ">Expiry Year</label>
            <div className="relative w-full">
              <select
                name="year"
                onChange={formik.handleChange}
        ...
        <div className="flex w-full space-x-4 mt-6 mb-6">
          <div className="flex w-1/2 flex-col items-start justify-start">
            <label className="text-[15px] mb-2 ">CVV</label>
            <div className="flex items-center justify-start w-full">
              <div className="flex-col items-center justify-start w-full">
                <input
                  ...
                  maxLength={4}
                  pattern="\d*"
                  className="w-full border-[1px] border-[#a7abad] px-4 py-2 text-[16px] sm:text-[14px] rounded-md h-12 focus:border-[#00C8FF] focus:outline-none focus:ring-2 focus:ring-[#00C8FF] focus:ring-opacity-50"
                  placeholder="CVV"
                />
        ...
        <SubmitButtonChallenge buttonCta={info.buttonCta} />
      </form>
...
export default PaymentOptionsChallenge;
