...
import QuantitySelectorChallenge from "./checkout-quantity-selector-challenge";
import CustomerInfoChallenge from "./checkout-customer-info-challenge";
import PaymentOptionsChallenge from "./checkout-payment-options-challenge";
...
import DiscountBarChallenge from "./checkout-discount-bar-challenge";
import HighDemandBannerChallenge from "./high-demand-banner-challenge";

type Props = {
  info: CheckoutPageType;
};

const CheckoutFormChallenge = ({ info }: Props) => {
      ...
      <div className="flex  w-full relative flex-col items-center bg-[#f1f4f8]">
        ...
        <div className="flex w-full max-w-[1100px] sm:px-4 pb-12 flex-wrap">
          <div className="flex flex-col w-full  lg:w-1/2 px-2 lg:py-8 pt-4 sm:pt-8 pb-4 bg-white">
            <DiscountBarChallenge
              product={product.product}
              info={info}
            />
            <HighDemandBannerChallenge />
            <div className="bg-white p-4 mt-4">
              <QuantitySelectorChallenge
                product={product}
                info={info}
            ...
            {/* <div className="bg-white p-4 mt-4 lg:hidden">
              <MobilePaymentOptions firePaypal={firePaypal} loading={loading} />
            </div> */}
            <div className="bg-white p-4 mt-4">
              <CustomerInfoChallenge formik={formik} />
            </div>
            <div className="bg-white p-4 mt-4">
              <PaymentOptionsChallenge
                info={info}
                product={product}
                formik={formik}
                loading={loading}
...
export default CheckoutFormChallenge;
