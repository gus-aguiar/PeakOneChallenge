...
const CustomerInfoChallenge = ({ formik }: CustomerInfoProps) => {
  ...
  return (
    <>
      <div className="flex w-full justify-start items-center pb-6 gap-3">
        <Image src="/images/icons/frm-hdr-icn2.png" alt="Timer icon" width={40} height={32} className="object-contain" />
      ...
      <form onSubmit={formik.handleSubmit}>
        <div className="flex w-full space-x-4">
          <div className="flex w-1/2 flex-col items-start justify-start">
            ...
            <input
              ...
              className="w-full border-[1px] border-[#a7abad]  px-4 py-2 text-[16px] rounded-md sm:text-[14px] h-12 focus:border-[#00C8FF] focus:outline-none focus:ring-2 focus:ring-[#00C8FF] focus:ring-opacity-50 transition-all duration-800 ease-in-out"
        ...
        <div className="flex w-full space-x-4 mt-6">
          <div className="flex w-full flex-col items-start justify-start">
            <label className="text-[15px] mb-2">Email Address</label>
            <input
              type="email"
              name="email"
              onChange={(e) => {
        ...
        <div className="flex w-full space-x-4 mt-6 mb-6">
          <div className="flex w-full flex-col items-start justify-start">
            <label className="text-[15px] mb-2">Phone Number</label>
            <input
              type="text"
              name="phone"
...
export default CustomerInfoChallenge;
